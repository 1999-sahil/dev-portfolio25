...
export default function AboutMe() {
  return (
    <div className="relative mx-auto h-full w-full max-w-5xl min-h-screen pt-5">
      <motion.div
        className="mt-4 px-4"
      ...
      >
        ...
        <p className="my-4 max-w-xl w-[90%] font-poppins text-sm font-normal text-neutral-500 dark:text-neutral-400">
          ...
          integrating APIs, or optimizing performance, I’m driven by the
          challenge of turning ideas into polished, production-ready products.
        </p>
        <p className="my-4 max-w-xl w-[90%] font-poppins text-sm font-normal text-neutral-500 dark:text-neutral-400">
        ...
        <p className="my-4 max-w-xl w-[90%] font-poppins text-sm font-normal text-neutral-500 dark:text-neutral-400">
          If you’re looking for a developer who can bring your vision to life
          with clean code, thoughtful design, and a bit of creative magic —
